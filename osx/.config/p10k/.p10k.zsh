# Generated by Powerlevel10k configuration wizard on 2024-04-19 at 16:19 +07.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 64646.
...
() {
  ...
  function my_git_formatter() {
    ...
    # flap: comment out below this to get clean git status
    # *42 if have stashes.
  ...
  # is empty.
  typeset -g POWERLEVEL9K_ANACONDA_CONTENT_EXPANSION='py:${${${${CONDA_PROMPT_MODIFIER#\(}% }%\)}:-${CONDA_PREFIX:t}}:$P9K_ANACONDA_PYTHON_VERSION'
